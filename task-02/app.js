...
const jsonPath = join(__dirname, 'db', 'plants.json')
...
/**
 * 4. A db/plants.json fájlban tárolt 'plants' tömbből egy elem kiválasztása az id 
 ...
 * @param {Number} id az id, amely alapján keresünk a tömbben
